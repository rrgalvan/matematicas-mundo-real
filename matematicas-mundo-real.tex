...
\begin{frame}{Modelos climáticos}
  \begin{minipage}{0.55\linewidth}
    ...
    \begin{flushleft}
     ...
     \\[0.3em]
     \hfill \footnotesize\color{darkgray}¿Existe solución? ¿Con qué características?
   \end{flushleft}
  \end{minipage}
  \hfill
...
\begin{frame}{Modelo 3D de flujo de corriente en el estrecho}
  \includemedia{Vídeo: gibraltar-tubes-3d-30s.mp4}{video/gibraltar-tubes-3d-30s.mp4}
\end{frame}
...
\begin{frame}{Tsunamis}
  ...
  \item \includemedia{Vídeo: tsunami2.avi}{video/tsunami2.avi}
  \end{itemize}
\end{frame}
